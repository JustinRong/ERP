  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<s:select name="em.gender" list="@com.myit.erp.auth.emp.vo.EmpModel@genderMap" cssStyle="width:190px"></s:select>
					  </td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<s:select name="depUuid" list="depList" listKey="uuid" listValue="name" cssStyle="width:190px" id="select"></s:select>	
